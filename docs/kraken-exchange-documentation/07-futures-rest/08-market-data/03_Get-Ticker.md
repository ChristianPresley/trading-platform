...
Source: [https://docs.kraken.com/api/docs/futures-api/trading/get-ticker](https://docs.kraken.com/api/docs/futures-api/trading/get-ticker)
...
**Full URL:** `https://futures.kraken.com/derivatives/api/v3/tickers/{symbol}`
...
```bash
curl -X GET "https://futures.kraken.com/derivatives/api/v3/tickers/{symbol}"
```
