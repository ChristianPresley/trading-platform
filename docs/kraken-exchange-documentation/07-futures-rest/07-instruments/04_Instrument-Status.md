...
Source: [https://docs.kraken.com/api/docs/futures-api/trading/instrument-status](https://docs.kraken.com/api/docs/futures-api/trading/instrument-status)
...
**Full URL:** `https://futures.kraken.com/derivatives/api/v3/instruments/{symbol}/status`
...
|-----------|------|----------|-------------|
| `symbol` | string | Yes | Market symbol. Example: `PF_BTCUSD` |
...
|-------|------|----------|-------------|
| `tradeable` | string | Yes | Market symbol Example: `PF_BTCUSD` |
| `experiencingDislocation` | boolean | Yes |  |
| `priceDislocationDirection` | ['string', 'null'] | Yes |  Enum: `ABOVE_UPPER_BOUND`, `BELOW_LOWER_BOUND` |
| `experiencingExtremeVolatility` | boolean | Yes |  |
| `extremeVolatilityInitialMarginMultiplier` | integer | Yes |  |
...
```bash
curl -X GET "https://futures.kraken.com/derivatives/api/v3/instruments/{symbol}/status"
```
