...
description: "Spec Pipeline — Overview of all 8 phases and how to invoke them in sequence. Use this agent when the user wants to understand the spec pipeline, see the phase map, or get guidance on which phase to run next."
